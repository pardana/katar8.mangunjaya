        ...
        <div class="box-body">
            <div class="clearfix">
                <div class="pull-right tableTools-container">
                    <a href="<?php echo base_url()."Bill/export_pdf"; ?>" target="_blank">
                    ...
                    <a href="<?php echo base_url()."Bill/export_excel"; ?>" target="_blank">
                    ...
                    <table id="tbl" class="table table-bordered table-condensed table-striped table-hover">
                        ...
                        <?php $i = 1; foreach ($order->result() as $row) { ?> 
                            ...
                            <tr>
                                ...
                                <td>
									<a href="<?php echo base_url()."bill/view/".$row->dlid; ?>">
